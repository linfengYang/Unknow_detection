...
from Dataset import load_nilm_data_bk, load_segment_data, load_UEA_data
...
def Data_Loader(config,X_train=None,y_train=None,X_test=None,y_test=None,image_train_path=None,imate_test_path=None):
    if config['data_dir'].split('/')[1] == 'Segmentation':
        ...
        Data = load_nilm_data_bk.load(config,X_train,y_train,X_test,y_test,image_train_path,imate_test_path) # load nilm Data
    return Data

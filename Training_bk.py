...
def unknow_module(unknow_point,cnt,X_train=None,y_train=None,X_test=None,y_test=None):
    if X_train is None:
    ...
    with open("unknow4.txt","a")as f:
        f.write("the {}: know_precision: {} unknow_precision: {} f1_score:{}\n".format(cnt,(1-FP/yy_test.shape[0]),(TP/sum(yy_test)),f_score))

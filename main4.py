...
from Models.model_copy import model_factory, count_parameters
from Models.optimizers import get_optimizer
from Models.loss import get_loss_module
from Models.utils import load_model
from Training_copy import SupervisedTrainer, train_runner,train_unknow,unknow_module
...
parser.add_argument('--emb_size', type=int, default=16, help='Internal dimension of transformer embeddings') # 16
...
parser.add_argument('--Fix_pos_encode', choices={'tAPE', 'Learn', 'Sin','None'}, default='tAPE',
                    help='Fix Position Embedding')
parser.add_argument('--Rel_pos_encode', choices={'eRPE', 'Vector','attention_ROPE','None'}, default='eRPE',
                    help='Relative Position Embedding')
# Training Parameters/ Hyper-Parameters ----------------
parser.add_argument('--epochs', type=int, default=250, help='Number of training epochs')        #batch_size100
parser.add_argument('--batch_size', type=int, default=10, help='Training batch size')  #16
parser.add_argument('--lr', type=float, default=5e-3, help='learning rate') #1e-3 #5e-3
